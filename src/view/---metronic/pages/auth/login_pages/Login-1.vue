...
<style lang="scss">
@import "@/assets/---metronic/sass/pages/login/login-1.scss";
</style>

<script>
import formValidation from "@/assets/---metronic/plugins/formvalidation/dist/es6/core/Core";

// FormValidation plugins
import Trigger from "@/assets/---metronic/plugins/formvalidation/dist/es6/plugins/Trigger";
import Bootstrap from "@/assets/---metronic/plugins/formvalidation/dist/es6/plugins/Bootstrap";
import SubmitButton from "@/assets/---metronic/plugins/formvalidation/dist/es6/plugins/SubmitButton";

import KTUtil from "@/assets/---metronic/js/components/util";
import { mapGetters, mapState } from "vuex";
import { LOGIN, LOGOUT, REGISTER } from "@/core/---metronic/services/store/auth.module";
