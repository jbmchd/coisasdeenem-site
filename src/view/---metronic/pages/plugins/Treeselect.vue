...
<script>
import KTCodePreview from "@/view/---metronic/content/CodePreview.vue";
import KTTreeSelect1 from "@/view/---metronic/pages/plugins/treeselect/Treeselect1";
import KTTreeSelect2 from "@/view/---metronic/pages/plugins/treeselect/Treeselect2";
import KTTreeSelect3 from "@/view/---metronic/pages/plugins/treeselect/Treeselect3";
import KTTreeSelect4 from "@/view/---metronic/pages/plugins/treeselect/Treeselect4";
import KTTreeSelect5 from "@/view/---metronic/pages/plugins/treeselect/Treeselect5";
import KTTreeSelect6 from "@/view/---metronic/pages/plugins/treeselect/Treeselect6";
import KTTreeSelect7 from "@/view/---metronic/pages/plugins/treeselect/Treeselect7";
import KTTreeSelect8 from "@/view/---metronic/pages/plugins/treeselect/Treeselect8";
import KTTreeSelect9 from "@/view/---metronic/pages/plugins/treeselect/Treeselect9";
import KTTreeSelect10 from "@/view/---metronic/pages/plugins/treeselect/Treeselect10";
import KTTreeSelect11 from "@/view/---metronic/pages/plugins/treeselect/Treeselect11";
import KTTreeSelect12 from "@/view/---metronic/pages/plugins/treeselect/Treeselect12";
import KTTreeSelect13 from "@/view/---metronic/pages/plugins/treeselect/Treeselect13";
import { SET_BREADCRUMB } from "@/core/---metronic/services/store/breadcrumbs.module";
