...
} from "@/core/---metronic/services/store/htmlclass.module";
import store from "@/core/---metronic/services/store";
import { ADD_CLASSNAME } from "@/core/---metronic/services/store/htmlclass.module";
...
const HtmlClass = {
  ...
  initThemes() {
    if (objectPath.get(this.config, "header.self.theme")) {
      ...
      import(`@/assets/---metronic/sass/themes/layout/header/base/${theme}.scss`);
    }
